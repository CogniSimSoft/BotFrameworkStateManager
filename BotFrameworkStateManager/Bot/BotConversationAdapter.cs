namespace BotFrameworkStateManager.Bot
{
    ...
    public class BotConversationAdapter : BotAdapter
    {
        public BotConversationAdapter() : base()
        {

        }

        public new BotConversationAdapter Use(IMiddleware middleware)
        {
            base.Use(middleware);
        ...
        public async Task ProcessActivity(string query, Func<ITurnContext, Task> callback = null)
        {
